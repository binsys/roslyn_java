...
namespace BoundTreeGenerator
{
				...
				case TargetLanguage.CSharp:
					{
						...
						var sss = targetLang == TargetLanguage.CSharp
							? "CSharpSyntaxNode syntax"
							: "JavaSyntaxNode syntax";
						IEnumerable<string> fields = isPublic ? new[] { sss } : new[] { "BoundKind kind", sss };
	...
	internal static class Extensions
	{
		...
		public static bool IsJavaKeyword(this string name)
		{
			switch (name)
			{
				case "bool":
