	...
	internal static class SyntaxEquivalence
	{
		...
		private static bool AreEquivalentRecursive(GreenNode before, GreenNode after, Func<SyntaxKind, bool> ignoreChildNode, bool topLevel)
		{
			...
			if (topLevel)
			{
				...
				// NOTE(cyrusn): Do we want to avoid going down into _annotation expressions?  I don't
				...
				// _annotation with that name.  It wouldn't be 100% correct (because of annoying things
