...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    internal partial class ExpressionGenerator : AbstractCSharpCodeGenerator
    {
        ...
        {
	        Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax.SyntaxFactory.LiteralExpression(SyntaxKind.NullKeyword);
			//return
			//	Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax.SyntaxFactory.LiteralExpression(
