...
namespace Microsoft.CodeAnalysis.CSharp.CodeGeneration
{
    internal partial class UsingDirectivesAdder : AbstractImportsAdder
    {
        ...
        protected override SyntaxNode GetInnermostNamespaceScope(SyntaxNodeOrToken nodeOrToken)
        {
            ...
            return node.GetAncestorOrThis<PackageDeclarationSyntax>() ?? (SyntaxNode)node.GetAncestorOrThis<CompilationUnitSyntax>();
        }
        ...
        {
            return contextNode is PackageDeclarationSyntax
                ? GetExistingNamespaces(semanticModel, (PackageDeclarationSyntax)contextNode, cancellationToken)
